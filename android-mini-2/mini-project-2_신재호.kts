 ...
 */
open class Cat constructor(age: Int) {
    val age: Int = age


    open fun jump(number: Int): String{
        return ""
    }
}
...
class Tiger : Cat{
    ...
    override fun jump(number: Int): String{
        ...
        val result: String = number.toString()+ " 미터를 점프 하였습니다"
        return result
    }
}
...
interface Calculator{
    // 더하기
    fun plus(num1 : Int , num2 : Int):Float
    //나누기
    fun div(num1 : Int , num2 : Int):Float
    //곱하기
    fun pro(num1 : Int , num2 : Int):Float
    //빼기
    fun sub(num1 : Int , num2 : Int):Float
}

class RealCalculator :Calculator{

    override fun plus(num1 : Int , num2 : Int):Float{
        return num1.toFloat() + num2.toFloat()
    }
    override fun div(num1 : Int , num2 : Int):Float{
        return num1.toFloat() / num2.toFloat()
    }
    override fun pro(num1 : Int , num2 : Int):Float{
        return num1.toFloat() * num2.toFloat()
    }
    override fun sub(num1 : Int , num2 : Int):Float{
        return num1.toFloat() - num2.toFloat()
    }
}
